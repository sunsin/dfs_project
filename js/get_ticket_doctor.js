...
$(function () {
    ...
    var doctorid = share_url.split("doctorid=")[1].split("&")[0];
    var post_url = "http://api.daifushuo.com:80/api/ousers/dfs_load_user_info?userid=" + doctorid;
    var share_title,share_content,share_img;
    $.get(post_url,function(data){
        //console.log(data);
        share_title = data.info.nickname;
        share_content = data.info.profile[0];
        share_img = data.info.avatar[0];
    })
    //server config
